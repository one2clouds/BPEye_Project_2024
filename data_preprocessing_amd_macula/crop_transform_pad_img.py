...
if __name__== '__main__':
    output_folder = "/mnt/Enterprise2/shirshak/ADAM_AgeRelatedMacularDegeneration/preprocessed_cropped_train_test_val_separated_ADAM"
    for split_name in ["train", "val", "test"]:
        os.makedirs(os.path.join(output_folder, split_name, "AMD"), exist_ok=True)
        os.makedirs(os.path.join(output_folder, split_name, "Non-AMD"), exist_ok=True)
    ...
    data_folder = sorted(glob("/mnt/Enterprise2/shirshak/ADAM_AgeRelatedMacularDegeneration/train_test_val_separated_ADAM/*/*/*.jpg"))
    ...
    for data in tqdm(data_folder):
        ...
        image_to_save.save(f"/mnt/Enterprise2/shirshak/ADAM_AgeRelatedMacularDegeneration/preprocessed_cropped_train_test_val_separated_ADAM/{data.split('/')[-3]}/{data.split('/')[-2]}/{data.split('/')[-1]}")