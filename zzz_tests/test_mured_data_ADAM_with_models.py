...
if __name__ == "__main__":
    ...
    test_data_paths = sorted(glob('/mnt/Enterprise2/shirshak/MURED_Dataset_for_ADAM/preprocessed_and_cropped_MURED_Data/*/*/*'))
    ...
    cm_display.plot()
    plt.savefig('/home/shirshak/BPEye_Project_2024/zzz_tests/CM_mured.png', dpi=500)
    plt.close()
    ...
    for count, wrong_case in enumerate(wrong_cases[:25]):
        ...
        plt.tight_layout()
        plt.show()
        plt.savefig(f"/home/shirshak/BPEye_Project_2024/zzz_tests/wrong_cases/wrong{count}.jpg")
        plt.close()
    ...
    for count, right_case in enumerate(right_cases[:25]):
        ...
        plt.tight_layout()
        plt.show()
        plt.savefig(f"/home/shirshak/BPEye_Project_2024/zzz_tests/right_cases/right{count}.jpg")
        plt.close()
