...
class AMDMaculaModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            train_data_paths = sorted(glob.glob(self.root_dir+"train/AMD/*.jpg")) + sorted(glob.glob(self.root_dir+"train/Non-AMD/*.jpg")) # from train path
            val_data_paths = sorted(glob.glob(self.root_dir+"val/AMD/*.jpg")) + sorted(glob.glob(self.root_dir+"val/Non-AMD/*.jpg")) # from validation path
            test_data_paths = sorted(glob.glob(self.root_dir+"test/AMD/*.jpg")) + sorted(glob.glob(self.root_dir+"test/Non-AMD/*.jpg")) # from test path
